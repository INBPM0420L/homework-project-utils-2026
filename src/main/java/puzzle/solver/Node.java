 ...
 */
public class Node<T, S extends State<T, S>> {

    private final S state;
    private final Set<T> moves;
    private final Node<T, S> parent;
     ...
     */
    public Node(S state, Node<T, S> parent, T move) {
        this.state = state;
     ...
     */
    public Optional<Node<T, S>> getParent() {
     ...
     */
    public Optional<Node<T, S>> nextChild() {
        if (!hasNextChild()) {
