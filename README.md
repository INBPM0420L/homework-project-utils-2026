homework-project-utils-2026
===========================

Utility classes for the Software Engineering and Technologies homework project.

If your project is about a logic puzzle, the class implementing the state-space representation must implement the [puzzle.State](https://inbpm0420l.github.io/homework-project-utils-2026/javadoc/puzzle/State.html) interface.

If your project is about a two-player game, the class implementing the state-space representation must implement the [game.State](https://inbpm0420l.github.io/homework-project-utils-2026/javadoc/game/State.html) interface.

## Documentation

* [Javadoc](https://inbpm0420l.github.io/homework-project-utils-2026/javadoc/)
...
<dependency>
    ...
    <artifactId>homework-project-utils-2026</artifactId>
...
<repositories>
    <repository>
        <id>github</id>
        <url>https://maven.pkg.github.com/INBPM0420L/homework-project-utils-2026</url>
    </repository>
</repositories>
```
